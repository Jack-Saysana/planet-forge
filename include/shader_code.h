...
"  float xper = clamp_fl((sin(25.0 * PI * tex_coords.x + time)));\n"
"  float yper = clamp_fl((sin(25.0 * PI * tex_coords.y + time)));\n"
"  yper += clamp_fl(sin(5.0 * PI * tex_coords.x + time));\n"
"  yper += clamp_fl(sin(75.0 * PI * tex_coords.y + time));\n"
"  yper += clamp_fl(sin(30.0 * PI * tex_coords.x + time));\n"
"  xper += clamp_fl(sin(17.0 * PI * tex_coords.x + time));\n"
"  xper += clamp_fl(sin(60.0 * PI * tex_coords.y + time));\n"
"  xper += clamp_fl(sin(24.0 * PI * tex_coords.x + time));\n"
"  xper += clamp_fl(cos(17.0 * PI * tex_coords.x + time));\n"
"  xper += clamp_fl(cos(60.0 * PI * tex_coords.y + time));\n"
"  xper += clamp_fl(cos(24.0 * PI * tex_coords.x + time));\n"
"  yper *= 0.125;\n"
"  xper *= 0.125;\n"
