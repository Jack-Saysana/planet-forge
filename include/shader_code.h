...
"  vec3 sand = vec3(246.0 / 255.0, 215.0 / 255.0, 176.0 / 255.0);\n"
"  vec3 g = vec3(0.0, 1.0, 0.0);\n"
"  vec3 b = vec3(0.0, 0.0, 1.0);\n"
"  vec3 w = vec3(1.0, 1.0, 1.0);\n"
"  vec3 black = vec3(0.0);\n"
"  float dist = dist_from_center();\n"
"  if (dist > 0.0 && dist < 1.001 * radius) {\n"
"    FragColor = vec4(mix(black, sand, (dist - radius) / (0.001 * radius)), 1.0);\n"
"  } else if (dist > 1.001 && dist < 1.025 * radius) {\n"
"    FragColor = vec4(mix(sand, g, (dist - (radius * 1.001)) / (0.025 * radius)), 1.0);\n"
